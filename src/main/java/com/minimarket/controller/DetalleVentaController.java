...
public class DetalleVentaController {
    ...
    @PreAuthorize("hasRole('CAJERO')") // Protegido: Solo CAJERO puede guardar
    @PostMapping
    ...
    @PreAuthorize("hasRole('CAJERO')") // Protegido: Solo CAJERO puede actualizar
    @PutMapping("/{id}")
    ...
    @PreAuthorize("hasRole('CAJERO')") // Protegido: Solo CAJERO puede eliminar
    @DeleteMapping("/{id}")
